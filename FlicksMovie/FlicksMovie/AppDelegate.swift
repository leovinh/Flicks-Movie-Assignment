...
//  FlicksMovie
//
//  Created by The Vinh Duong on 3/8/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "movie_small")
        ...
        topRatedNavigationController.tabBarItem.image = UIImage(named: "star_small")
